...
- `docker-compose.yml`, where present, builds httptape from this repository's root `Dockerfile` (tagged `httptape:demo`) so the example always exercises the in-repo version.
